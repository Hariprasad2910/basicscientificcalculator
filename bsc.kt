package com.example.basicscientificcalculator
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bsin.setOnClickListener {
            tvMain.text = (tvMain.text.toString() + "(180 − θ)")
            tvsec.text = (bsin.text.toString())
        }
        bcos.setOnClickListener {
            tvMain.text = (tvMain.text.toString() + "√3/2")
            tvsec.text = (bcos.text.toString())
        }
        btan.setOnClickListener {
            tvMain.text = (tvMain.text.toString() + "0")
            tvsec.text = (btan.text.toString())
        }
